  ...
  return (
    ...
    >
      ...
      <div className='control-pane'>
            ...
            <TreeMapComponent height={height.toString()} width={width.toString()} itemClick={itemMove.bind(this)} itemMove={itemMove.bind(this)} load={load.bind(this)} id='treemap-container' titleSettings={{
